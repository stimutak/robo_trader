...
class AttributionAnalyzer:
    ...
    def holdings_based_attribution(
        ...
        # Align all data
        common_index = (
            portfolio_returns.index.intersection(holdings.index)
    ...
    def factor_attribution(
        ...
        """
        # Align data
        common_index = portfolio_returns.index.intersection(factor_returns.index).intersection(
    ...
    def sector_attribution(
        ...
        # Align data
        common_index = portfolio_returns.index.intersection(sector_weights.index).intersection(
    ...
    def style_attribution(
        ...
        """
        # Align data
        common_index = portfolio_returns.index.intersection(style_factors.index).intersection(
    ...
    def timing_attribution(
        self, portfolio_returns: pd.Series, benchmark_returns: pd.Series, portfolio_beta: pd.Series
    ) -> Dict:
        ...
        """
        # Align data
        common_index = portfolio_returns.index.intersection(benchmark_returns.index).intersection(
    ...
    def transaction_cost_attribution(
        self, gross_returns: pd.Series, net_returns: pd.Series, transaction_costs: pd.Series
    ) -> Dict:
        ...
        """
        # Align data
        common_index = gross_returns.index.intersection(net_returns.index).intersection(
