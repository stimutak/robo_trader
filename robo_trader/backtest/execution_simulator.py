...
class AdvancedExecutionSimulator:
    ...
    def get_metrics(self) -> Dict[str, any]:
        ...
        return {
            'fill_rate': self.execution_metrics['filled_orders'] / max(1, self.execution_metrics['total_orders']),
            'partial_fill_rate': self.execution_metrics['partial_fills'] / max(1, self.execution_metrics['total_orders']),
            'avg_slippage': np.mean(self.execution_metrics['avg_slippage']) if self.execution_metrics['avg_slippage'] else 0,
