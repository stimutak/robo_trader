...
class ProductionConfig:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        sensitive_fields = ['api_key', 'secret_key', 'encryption_key', 
                          'pg_password', 'smtp_password', 'slack_webhook_url']
...
class ConfigManager:
    ...
    def _merge_config(self, config: ProductionConfig, data: Dict[str, Any]) -> ProductionConfig:
        ...
        root_fields = ["debug_mode", "log_level", "enable_caching", 
                      "cache_ttl_seconds", "request_rate_limit"]
