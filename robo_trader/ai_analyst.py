...
class AIAnalyst:
    ...
    def analyze_market_event(self, symbol: str, event_text: str, 
                            market_data: Optional[Dict] = None) -> MarketAnalysis:
        """
    ...
    def _build_analysis_prompt(self, symbol: str, event_text: str, 
    ...
    def _call_llm(self, prompt: str) -> str:
        ...
        if self.provider == "openai":
            response = self.client.ChatCompletion.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are a master trader with deep market knowledge."},
