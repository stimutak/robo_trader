...
class DatabaseMonitor:
    ...
    async def _cleanup_stale_locks(self, lock_holders: List[Dict]):
        ...
        for holder in lock_holders:
            ...
            if any(keyword in command.lower() for keyword in ['python', 'runner_async', 'robo_trader']):
                ...
                if process_info and 'command' in process_info:
                    ...
                    if 'robo_trader' in full_command.lower() or 'runner_async' in full_command.lower():
