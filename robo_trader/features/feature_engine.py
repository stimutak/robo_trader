...
class FeatureEngine:
    ...
    async def calculate_features(self, 
                                symbol: str, 
                                data: pd.DataFrame,
                                feature_set_name: str = 'technical') -> Dict[str, FeatureValue]:
        """
        ...
        with self.performance_monitor.timer_context('feature_calculation'):
            ...
            if self._is_cache_valid(cache_key):
                logger.debug("Using cached features", symbol=symbol, 
            ...
            try:
                ...
                self.performance_monitor.increment_counter('features_calculated', 
                                                         len(features))
    ...
    async def calculate_features_batch(self, 
                                      symbols: List[str],
                                      data_dict: Dict[str, pd.DataFrame],
                                      feature_set_name: str = 'technical') -> Dict[str, Dict[str, FeatureValue]]:
        """
        ...
        for symbol, result in zip(symbols, results):
            if isinstance(result, Exception):
                logger.error("Error in batch feature calculation", 
    ...
    async def get_latest_features(self, 
                                 symbol: str, 
    ...
    async def get_feature_correlation_matrix(self, 
                                            symbols: List[str],
    ...
    def clear_cache(self, symbol: Optional[str] = None):
        ...
        if symbol:
            ...
            keys_to_remove = [k for k in self._feature_cache.keys() 
    ...
    async def cleanup_old_features(self, days_to_keep: int = 30):
        ...
        logger.info("Cleaned up old features", rows_deleted=rows_deleted, 
    ...
    def get_feature_info(self) -> Dict[str, Any]:
        ...
        info = {
            ...
            'last_cache_clear': self._last_cache_clear.isoformat() if self._last_cache_clear else None
        }
        ...
        for name, feature_set in self.feature_sets.items():
            info['feature_sets'][name] = {
                ...
                'last_update': feature_set._last_update.isoformat() if feature_set._last_update else None
            }
