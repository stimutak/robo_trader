...
from robo_trader.strategies.framework import Strategy, StrategyMetrics, StrategyState
...
async def test_portfolio_manager():
    ...
    print(
        f"✅ Created portfolio manager with {portfolio_manager.allocation_method.value} allocation"
    )
