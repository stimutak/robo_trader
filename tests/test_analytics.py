...
class TestPerformanceAnalyzer:
    ...
    def test_performance_summary(self, sample_returns, sample_benchmark):
        ...
        # Test with benchmark
        summary_with_bench = analyzer.performance_summary(
            sample_returns, 
            sample_benchmark
        )
...
class TestRiskAnalyzer:
    ...
    def test_portfolio_var(self, sample_portfolio_returns):
        ...
        # Test historical VaR
        var_hist = analyzer.portfolio_var(
        ...
        # Test parametric VaR
        var_param = analyzer.portfolio_var(
            sample_portfolio_returns, 
            weights, 
            method="parametric"
        )
...
class TestAttributionAnalyzer:
    ...
    def test_regime_attribution(self, sample_returns):
        ...
        regime_indicator = pd.Series(
            np.random.choice([0, 1, 2], size=len(sample_returns)),
            index=sample_returns.index
        )
        
        regime_names = {0: "Bull", 1: "Bear", 2: "Sideways"}
        
        attribution = analyzer.regime_attribution(
            sample_returns,
            regime_indicator,
            regime_names
        )
