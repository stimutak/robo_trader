...
from robo_trader.bug_detection.config import (
    DEFAULT_CONFIG,
    DEVELOPMENT_CONFIG,
    PRODUCTION_CONFIG,
)
...
async def run_scan(config_name: str = "default", output_file: str = None, 
                  severity_filter: str = None, tools: list = None):
...
Examples:
  ...
  python scripts/bug_detector.py --scan --tools mypy,bandit --output bugs.json
    ...
    action_group.add_argument("--scan", action="store_true", 
                            help="Run a full bug scan")
    action_group.add_argument("--watch", action="store_true",
                            help="Watch files for changes and analyze")
    
    # Configuration
    parser.add_argument("--config", choices=["default", "development", "production"],
    ...
    parser.add_argument("--list-tools", action="store_true",
                       help="List available static analysis tools")
