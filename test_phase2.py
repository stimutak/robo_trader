...
from robo_trader.data.pipeline import DataPipeline, TickData, BarData, DataSubscriber
from robo_trader.features.engine import FeatureEngine
from robo_trader.features.indicators import TechnicalIndicators, IndicatorConfig
...
async def test_data_pipeline():
    ...
    try:
        ...
        print_result("Pipeline initialization", True, 
                    f"Created buffers for {len(config.symbols)} symbols")
        ...
        print_result("Data streaming", True, 
                    f"Received {subscriber.ticks_received} ticks")
        ...
        print_result("Historical data", True, 
                    f"Fetched {len(hist_data)} bars")
        
        # Test 5: Tick aggregation
        bar = await pipeline.aggregate_ticks_to_bars("AAPL", timedelta(minutes=1))
        print_result("Tick aggregation", bar is not None,
        ...
        print_result("Pipeline metrics", True,
...
async def test_feature_engine():
    ...
    try:
        ...
        print_result("Feature calculation", True,
                    f"Calculated {len(non_null)} features")
        ...
        print_result("Technical indicators", 
        ...
        print_result("Feature caching", True,
...
def test_technical_indicators():
    ...
    try:
        ...
        print_result("MACD calculation", True, 
        ...
        print_result("Bollinger Bands", True,
...
def test_data_validation():
    ...
    try:
        ...
        print_result("Valid tick validation", all_valid,
        ...
        print_result("Invalid tick detection", has_error,
                    "Correctly identified inverted market")
        ...
        outlier_detected = any('outlier' in r.check_name.lower() and not r.is_valid for r in results)
        print_result("Outlier detection", outlier_detected,
                    "Correctly identified price outlier")
        ...
        print_result("Market hours (regular)", is_open,
        ...
        print_result("Market hours (extended)", is_extended,
        ...
        print_result("Market hours (weekend)", is_closed,
                    "Correctly identified closed market")
        
        # Test 5: Data quality metrics
        metrics = validator.get_metrics()
        assert metrics.total_ticks > 0, "No ticks processed"
        print_result("Data quality metrics", True,
...
def test_bar_validation():
    ...
    try:
        ...
        print_result("Valid bar", all_valid,
                    "All OHLCV relationships correct")
        ...
        print_result("Invalid bar detection", has_error,
                    "Correctly identified invalid OHLC")
...
async def test_integration():
    ...
    try:
        ...
        print_result("Component integration", True,
                    "Pipeline connected to feature engine")
        ...
        print_result("End-to-end data flow", features_calculated,
        ...
        print_result("Validation integration", validation_working,
