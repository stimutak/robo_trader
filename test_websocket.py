                ...
                while asyncio.get_event_loop().time() < end_time:
                    try:
                        ...
                        if data.get("type") == "market_data":
                            ...
                            print(f"💰 Trade: {data.get('side')} {data.get('quantity')} {data.get('symbol')} @ ${data.get('price'):.2f}")
                        elif data.get("type") == "signal":
                            print(f"🔔 Signal: {data.get('signal')} {data.get('symbol')} (strength: {data.get('strength')})")
