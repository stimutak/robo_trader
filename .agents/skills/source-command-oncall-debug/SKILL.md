---
name: "source-command-oncall-debug"
description: "Systematic production debugging workflow"
---

# source-command-oncall-debug

Use this skill when the user asks to run the migrated source command `oncall-debug`.
...
Search AGENTS.md for similar patterns:
...
1. AGENTS.md → "Common Mistakes" section
