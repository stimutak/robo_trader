...
class TestOrderFlowImbalanceStrategy:
    ...
    def test_buy_signal_with_imbalance(self):
        ...
        market_data = {"orderbook": create_mock_orderbook(bid_size=1500, ask_size=500)}
    ...
    def test_sell_signal_on_reversal(self):
        ...
        market_data = {"orderbook": create_mock_orderbook(bid_size=500, ask_size=1500)}
...
class TestSpreadTradingStrategy:
    ...
    def test_quote_calculation(self):
        ...
        market_data = {"orderbook": create_mock_orderbook()}
    ...
    def test_competitive_quote_check(self):
        ...
        market_data = {"orderbook": create_mock_orderbook(bid_price=99.95, ask_price=100.05)}
...
class TestMicrostructureConfig:
    ...
    def test_custom_config(self):
        ...
        config = MicrostructureConfig(
            ofi_entry_threshold=0.5, max_position_size=2000, tick_window=30
        )
...
def test_integration_scenario():
    ...
    config = MicrostructureConfig(ofi_entry_threshold=0.2, min_order_size=100, max_order_size=500)

    # Test OFI strategy
    ofi_strategy = OrderFlowImbalanceStrategy(config)

    # Simulate market conditions
    market_data_bullish = {"orderbook": create_mock_orderbook(bid_size=2000, ask_size=500)}
    ...
    market_data_bearish = {"orderbook": create_mock_orderbook(bid_size=500, ask_size=2000)}
